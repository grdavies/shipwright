"""Pytest port of run_plan_proposed_parity_fixtures.py (PRD 054 W4 behavioral)."""
...
_HARNESS = "harness_plan_proposed_parity.py"
...
def _load_harness(repo_root: Path):
    ...
    spec = importlib.util.spec_from_file_location("harness_plan_proposed_parity", path)
...
def test_plan_proposed_parity_behavior(repo_root: Path, sw_env: dict[str, str], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_plan_proposed_parity_harness_present(repo_root: Path) -> None:
