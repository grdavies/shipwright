"""Pytest port of run_base_resolution_fixtures.py (PRD 054 W4 behavioral)."""
...
_HARNESS = "harness_base_resolution.py"
...
def _load_harness(repo_root: Path):
    ...
    spec = importlib.util.spec_from_file_location("harness_base_resolution", path)
...
def test_base_resolution_behavior(repo_root: Path, sw_env: dict[str, str], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_base_resolution_harness_present(repo_root: Path) -> None:
