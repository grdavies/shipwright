"""Pytest port of run_refactor_step_fixtures.py (PRD 054 W1 behavioral)."""
...
_HARNESS = "harness_refactor_step.py"
...
def _load_harness(repo_root: Path):
    ...
    spec = importlib.util.spec_from_file_location("harness_refactor_step", path)
...
def test_refactor_step_behavior(repo_root: Path, sw_env: dict[str, str], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_refactor_step_harness_present(repo_root: Path) -> None:
