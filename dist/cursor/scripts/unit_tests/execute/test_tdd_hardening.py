"""Pytest port of run_tdd_hardening_fixtures.py (PRD 054 W1 behavioral)."""
...
_HARNESS = "harness_tdd_hardening.py"
...
def _load_harness(repo_root: Path):
    ...
    spec = importlib.util.spec_from_file_location("harness_tdd_hardening", path)
...
def test_tdd_hardening_behavior(repo_root: Path, sw_env: dict[str, str], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_tdd_hardening_harness_present(repo_root: Path) -> None:
