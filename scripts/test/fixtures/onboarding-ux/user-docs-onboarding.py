...
check_file getting-started "$ROOT/core/documentation/getting-started.md"
check_file commands "$ROOT/core/documentation/commands.md"

# Cross-doc: CodeRabbit opt-in (not default) mentioned somewhere user-facing
if grep -rlE 'opt-in|default.*`none`|default is `none`' "$ROOT/README.md" "$ROOT/core/documentation" >/dev/null 2>&1; then
