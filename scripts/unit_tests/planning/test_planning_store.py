...
from planning_store import IssueStoreBackend, _default_body_path, doctor, doctor_absorb_asymmetry
...
# --- PRD 094 R18 doctor absorb-asymmetry (folded to avoid workflow regen) ---


def _seed_prd_gap_asymmetry_pair(
    root: Path,
    cfg: dict,
    *,
    prd_unit: str,
    ...
    store = FixtureIssuesStore(root / ".cursor/hooks/state/issue-store-fixture.json")
    for unit_id in (prd_unit, gap_unit):
