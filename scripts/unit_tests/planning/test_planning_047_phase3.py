"""Pytest port — PRD 047 phase-3 Bitbucket guidance + e2e acceptance."""
from __future__ import annotations
import importlib.util, sys
from pathlib import Path
import pytest
_PKG = "scripts/unit_tests/planning"
_HARNESS = "harness_planning_047_phase3.py"
...
def test_planning_047_phase3(repo_root: Path, sw_env: dict, monkeypatch: pytest.MonkeyPatch) -> None:
