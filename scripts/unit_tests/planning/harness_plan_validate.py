...
# PRD 057 R5: this harness runs `wave plan --dry-run` directly against the real repo root
# (not an isolated fixture clone), so its dependency-gate eligibility check now goes through
...
# this fixture keeps exercising local wave-plan routing/validation, not live issue-store
