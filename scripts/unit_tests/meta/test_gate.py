"""Pytest port of run_gate_fixtures.py (PRD 054 W4 behavioral)."""
...
def test_gate_behavior(repo_root: Path, sw_env: dict[str, str], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_gate_harness_present(repo_root: Path) -> None:
