...
_HARNESS = "harness_planning_issue_store_migrate.py"
...
def _load_harness(repo_root: Path):
    ...
    spec = importlib.util.spec_from_file_location("harness_planning_issue_store_migrate", path)
...
@pytest.mark.git
def test_planning_issue_store_migrate_behavior(
