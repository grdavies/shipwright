"""Pytest port of run_onboarding_ux_fixtures.py (PRD 054 W4 behavioral)."""
...
_HARNESS = "harness_onboarding_ux.py"
...
def _load_harness(repo_root: Path):
    ...
    spec = importlib.util.spec_from_file_location("harness_onboarding_ux", path)
...
def test_onboarding_ux_behavior(repo_root: Path, sw_env: dict[str, str], monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_onboarding_ux_harness_present(repo_root: Path) -> None:
