...
`python3 scripts/docs-currency-gate.py restamp-command-doc <repo-root> core/commands/sw-tasks.md` bumps
...
<!-- currency: refreshed 2026-09-18T01:51:00Z — terminal-ship after check_frozen_lib equivalent() -->
