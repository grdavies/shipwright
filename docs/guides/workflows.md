...
**Graph runtime (PRD 269 R17):** after cutover, deliver (and the other orchestrators) compile onto
...
See [`commands.md` — Graph execution runtime](commands.md#graph-execution-runtime-prd-269-r17) and
