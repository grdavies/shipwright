...
| Closeout hardening (PRD 278) | Phase-ship hygiene auto-repair (`phase_ship_hygiene.py`); prefer-run-scoped adopt (`wave_run_adopt.py`); numeric absorb exactly-one (`planning_store_facade.py` closeout). Absorb map: #730→R1–R2, #731→R3–R5, #739→R6–R8. See `core/commands/sw-deliver.md` **Closeout hardening**. |
