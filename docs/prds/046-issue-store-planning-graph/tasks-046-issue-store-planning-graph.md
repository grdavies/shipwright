...
- [x] 1.1 Backend-pluggable `discover_units` (R83)
  ...
  - **R-IDs:** R83
- [x] 1.2 Region disposition + committed `inFlight` read-only projection (R80, D22, D23)
  ...
  - **R-IDs:** R80
- [x] 1.3 Serialized concurrent INDEX regeneration (R88)
  ...
  - **R-IDs:** R88
- [x] 1.4 Single-authority gated cutover (R87)
  ...
  - **R-IDs:** R87
- [x] 1.5 Semantic parity fixture (R92)
  ...
  - **R-IDs:** R92
- [x] 1.7 Region-marker newline invariant (R100, TR-A4-1)
  - **File:** `scripts/planning_index_gen.py`
  ...
  - **R-IDs:** R100
- [x] 1.8 gap-020 closure fixtures + glued-marker guard (R101–R103, TR-A4-2–TR-A4-4)
