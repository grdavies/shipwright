...
- Rule-class promotion remains human-gated via `/pf-memory-audit` + allowlist.
...
…without `workflow.config.json`. The fail-closed hook engages via the marker; run `/pf-setup` to customize.
